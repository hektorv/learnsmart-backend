...
class ContentServiceIntegrationTests {
        ...
        void fullContentFlow() throws Exception {
                ...
                String domainIdStr = objectMapper.readTree(domainResult.getResponse().getContentAsString()).get("id")
                                .asText();
                ...
                contentInput.setMetadata(java.util.Map.of("url", "http://video.com"));
